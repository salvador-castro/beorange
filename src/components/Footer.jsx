...
export default function Footer() {
  return (
    <>
      <section
        id="contacto"
        className="bg-[#F2902A] w-full py-16 relative overflow-hidden"
      >
      ...
      <footer className="bg-[#0E0E0E] w-full text-gray-300">
            ...
            <div className="flex flex-col gap-8 md:col-span-1">
              <div className="flex gap-12">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="https://www.instagram.com/beorange.uy/"
                    ...
                    <a
                      href="https://www.youtube.com/@bitcoinweekuy"
                      className="hover:text-white transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="https://wa.me/5491135655755"
                      className="hover:text-white transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
              ...
              <div className="flex flex-col gap-2">
                ...
                <span className="text-sm">
                  Sinergia Faro, Punta Carretas, Montevideo.
                </span>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-[#E75515] to-[#812F0C] py-3 px-6 flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 text-white text-sm font-medium w-full shadow-inner text-center">
          <span>
            BE ORANGE — The Bitcoiner Meeting 24 de mayo de 2026 · Montevideo,
            Uruguay
          </span>
