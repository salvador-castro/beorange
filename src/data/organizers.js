export const ORGANIZERS = [
  {
    logo: '/logos/roderich/logoRoderich.webp',
    alt: 'Roderich',
  ...
  {
    logo: '/logos/plugin/logoPlugin.webp',
    alt: 'Plugin',
    url: 'https://plugin.uy/',
    description:
...
export const CONTACT_EMAILS = ['comunicacion@roderichs.com', 'info@plugin.uy']
